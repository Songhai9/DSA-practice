...
Cette fois-ci vous ne connaissez pas à l'avance le nombre de déplacement effectués et vous n'avez pas le droit d'utiliser de tableaux.
...
**Vous n'avez pas le droit d'utiliser de tableaux**.
**votre programme doit s'appeler `chemin` compilé à partir de `chemin.c`**
